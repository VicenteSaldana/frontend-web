function Conocenos() {
    return <div className="flex-container-nosotros">
    <div className="box"> 
    ...
    <div className="flex-container-integrantes">
        ...
        <div className="flex-container-integrante">
            ...
            <div className="box">holaa soy Rafael, Tengo 22 años y soy de 5 año de ingeniería. Me gusta el manga, el anime 
        ...
        <div className="flex-container-integrante">
        <div className="flex-item-picture"><img src={require("../imgs/miguelito.jpeg")} alt = "miguelito"/></div>
            <div className="box">Hola! soy José y tengo 22 años, actualmente me encuentro cursando 4° 
        ...
        <div className="flex-container-integrante">
        <div className="flex-item-picture"><img src={require("../imgs/miguelito.jpeg")} alt = "miguelito"/></div>
            <div className="box">Holaa soy Vicente, tengo 20 años y voy en mi tercer año de ingeniería.
