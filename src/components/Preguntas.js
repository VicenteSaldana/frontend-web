function Preguntas(){
    ...
    <ul className="preguntas">
        ...
        <li>¿Qué es esto?
        <dd><p>Esta es la página web de "Ratón Volador", un juego diseñado para que tú y tus amigos puedan 
            compartir horas de risas y diversión.
        </p></dd>
        </li>
        <li >¿Cómo me registro?
        <dd><p>Para registrarte basta con acceder a la sección de "Regístrate" en la barra de navegación, ya ahí debes
